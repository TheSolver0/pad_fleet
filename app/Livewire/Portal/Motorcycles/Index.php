...
namespace App\Livewire\Portal\Motorcycles;
...
class Index extends Component
{
    ...
    {
        $v = Vehicle::with('vehicleModel.brand')->where('category', Vehicle::CATEGORY_MOTO)->findOrFail($id);
        $this->editingId = $v->id;
    ...
    public function saveMoto(): void
    {
        ...
        $data = [
            ...
            'category' => Vehicle::CATEGORY_MOTO,
    ...
    public function deleteMoto(): void
    {
        if ($this->editingId) {
            Vehicle::where('category', Vehicle::CATEGORY_MOTO)->findOrFail($this->editingId)->delete();
            $this->dispatch('notify', type: 'success', message: 'Moto supprimée.');
        }
    ...
    public function render(): View
    {
        ...
        ])->layout('layouts.app', ['title' => 'Gestion des motos']);
    }
}
