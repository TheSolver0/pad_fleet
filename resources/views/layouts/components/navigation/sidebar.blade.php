@php
    ...
    $groups = [
        ...
        [
            ...
            'routes' => ['garages.index', 'repairs.index', 'repairs.stock-usage', 'repairs.documents', 'mechanics.index', 'mechanics.my-work', 'diagnostics.index', 'work-orders.index', 'vehicles.control-sheets'],
            'items'  => [
