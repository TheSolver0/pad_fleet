@php
    ...
    $groups = [
        [
            ...
            'routes' => ['missions.index', 'missions.analytics', 'missions.synthesis', 'schedules.index', 'reports.index', 'reports.vehicle-consumption', 'reports.vehicle-reform', 'vehicles.control-sheets', 'city-distances.index'],
            'items'  => [
                ...
                ['route' => 'city-distances.index',        'label' => 'Distances villes',   'icon' => 'bi bi-signpost-split'],
                ...
                ['route' => 'reports.vehicle-reform',      'label' => 'Réforme',            'icon' => 'bi bi-slash-circle'],
            ],
        ],
        [
            'id'     => 'flotte',
        ...
        [
            ...
            'routes' => ['drivers.index', 'drivers.driving-licenses', 'drivers.documents', 'drivers.leaves', 'drivers.dispatches', 'affectations.index', 'demandeurs.index'],
            'items'  => [
                ...
                ['route' => 'drivers.leaves',           'label' => 'Congés / Absences',   'icon' => 'bi bi-calendar-x'],
                ['route' => 'drivers.dispatches',       'label' => 'Mise à disposition',  'icon' => 'bi bi-person-gear'],
