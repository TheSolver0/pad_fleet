...
<div class="modal show d-block" tabindex="-1" style="background: rgba(0,0,0,0.35); z-index: 1060;">
                ...
                <div class="modal-body py-3">
                    <div class="row g-2">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm" wire:model="quick_name" placeholder="Nom complet">
                            @error('quick_name') <span class="small text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-12">
                            <label class="form-label small">Email</label>
                            <input type="email" class="form-control form-control-sm" wire:model="quick_email" placeholder="email@exemple.com">
                            @error('quick_email') <span class="small text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-6">
    ...
    @endforeach
                ...
                <div class="modal-footer py-2">
                    <button type="button" class="btn btn-sm btn-outline-secondary" wire:click="closeQuickAddPerson">Annuler</button>
