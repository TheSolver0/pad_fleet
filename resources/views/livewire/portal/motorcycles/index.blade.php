<div>
    <p class="section-label">Gestion des motos</p>

    <div class="activity-card mb-4">
        <div class="activity-card-header">
            <div class="module-toolbar">
                <span class="module-toolbar-title">Motos</span>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="text-center text-muted py-4">Aucune moto. Cliquez sur « Nouvelle moto » pour ajouter.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="row g-3">
            ...
            @empty
                <div class="col-12 text-center text-muted py-5">Aucune moto. Cliquez sur « Nouvelle moto » pour ajouter.</div>
            @endforelse
        </div>
        @endif
        @if($motos->hasPages())
            <div class="p-3 border-top">{{ $motos->links() }}</div>
        @endif
    </div>

    @include('livewire.portal.motorcycles.partials.modal-form')
    @include('livewire.portal.motorcycles.partials.modal-quick-add-person')
    @include('livewire.portal.motorcycles.partials.modal-documents')
    @include('livewire.portal.motorcycles.partials.modal-delete')
</div>
