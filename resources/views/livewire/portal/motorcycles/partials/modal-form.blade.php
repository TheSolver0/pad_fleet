                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" id="motoperiodIndefinite" wire:model.live="assignment_period_indefinite">
                                <label class="form-check-label small" for="motoperiodIndefinite">Indéfinie</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">Photos de la moto (optionnel)</label>
