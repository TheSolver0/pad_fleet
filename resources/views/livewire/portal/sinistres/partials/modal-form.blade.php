@if ($showFormModal)
    <div class="modal show d-block" tabindex="-1" style="background: rgba(0,0,0,0.4);" style="margin-top: -50px; height: 1000px;" >
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content" style="max-height: 200%">
                ...
                <form wire:submit="saveSinistre">
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Chauffeur impliqué</label>
                                ...
                                <select class="form-select" wire:model="mission_id">
                                    ...
                                    @foreach ($missions as $m)
                                        <option value="{{ $m->id }}">#{{ $m->id }}
                                            {{ $m->date_start->format('d/m/Y') }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Date/heure déclaration <span
                                        class="text-danger">*</span></label>
                                <input type="datetime-local"
                                    class="form-control @error('declared_at') is-invalid @enderror"
                                    wire:model="declared_at">
                                @error('declared_at')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" wire:model="estimated_cost"
                                    placeholder="ex. 1 234 567,89" inputmode="decimal">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" wire:model="responsibility"
                                    placeholder="tiers, nous, partagé...">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" wire:model="police_report_file"
                                    accept=".pdf,image/*">
                                @error('police_report_file')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit"
                            class="btn btn-primary">{{ $editingId ? 'Enregistrer' : 'Déclarer' }}</button>
                    </div>
                </form>
            </div>
        </div>
