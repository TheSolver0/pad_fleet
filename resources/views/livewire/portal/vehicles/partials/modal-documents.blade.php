                ...
                <section class="mb-4">
                    ...
                    <ul class="list-group list-group-flush small">
                        @forelse($docVehicle->documents as $doc)
                            <li wire:key="vehicle-doc-{{ $doc->id }}" class="list-group-item d-flex justify-content-between align-items-center py-2">
                ...
                <section class="mb-4">
                    ...
                    <div class="row g-2">
                        @foreach($docVehicle->photos as $photo)
                            <div class="col-6 col-md-4 col-lg-3" wire:key="vehicle-photo-{{ $photo->id }}">
                    ...
                    @if($docVehicle->photos->isEmpty())
                        <p class="small text-muted mb-0">Aucune photo. Ajoutez des photos du véhicule ci-dessus.</p>
                    @endif
                </section>
